...
const ko: Translations = {
  ...
  dataDemoScreen: {
    supabaseTitle: "데이터 데모 (Supabase)",
    supabaseSubtitle: "React Query + Supabase SDK",
    convexTitle: "데이터 데모 (Convex)",
    convexSubtitle: "리액티브 쿼리 - 자동 업데이트!",
    realtimeInfo: "다른 창에서 이 앱을 열어 보세요 - 게시물이 실시간으로 동기화됩니다!",
    loadingPosts: "게시물을 불러오는 중...",
    errorHeading: "게시물을 불러오지 못했습니다",
    retryButton: "다시 시도",
    formTitle: "게시물 작성",
    titlePlaceholder: "제목",
    contentPlaceholder: "내용",
    createButton: "게시물 작성",
    emptyHeading: "아직 게시물이 없습니다",
    emptyContent: "위에서 첫 게시물을 작성하세요",
  },
  demoNavigator: {
    componentsTab: "컴포넌트",
    debugTab: "디버그",
