...
const fr: Translations = {
  ...
  dataDemoScreen: {
    supabaseTitle: "Démo de données (Supabase)",
    supabaseSubtitle: "React Query + SDK Supabase",
    convexTitle: "Démo de données (Convex)",
    convexSubtitle: "Requêtes réactives, mise à jour automatique !",
    realtimeInfo:
      "Ouvrez cette app dans une autre fenêtre : les publications se synchronisent en temps réel !",
    loadingPosts: "Chargement des publications...",
    errorHeading: "Impossible de charger les publications",
    retryButton: "Réessayer",
    formTitle: "Créer une publication",
    titlePlaceholder: "Titre",
    contentPlaceholder: "Contenu",
    createButton: "Créer la publication",
    emptyHeading: "Aucune publication pour l'instant",
    emptyContent: "Créez votre première publication ci-dessus",
  },
  demoNavigator: {
