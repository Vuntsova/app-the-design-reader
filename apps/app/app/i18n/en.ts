...
const en = {
  ...
  birthDataScreen: {
    ...
    subtitle: "We calculate your chart from your local birth date, time, and place.",
    datetimeLabel: "Birth date & time",
    datetimePlaceholder: "Select date and time",
    datetimeHelper: "Use your local wall-clock time — the engine handles the timezone.",
    locationLabel: "Birth place",
    locationPlaceholder: "e.g. Seoul",
    locationHelper: "City, town, municipality, island, or country. Free-form addresses are rejected.",
    locationSearching: "Searching…",
    locationNoResults: "No matches. Try 'City, Country'.",
    locationPickPrompt: "Pick a result from the list to continue.",
    nameLabel: "Name (optional)",
    namePlaceholder: "For your own reference",
