...
const ar: Translations = {
  ...
  dataDemoScreen: {
    supabaseTitle: "عرض البيانات (Supabase)",
    supabaseSubtitle: "React Query + Supabase SDK",
    convexTitle: "عرض البيانات (Convex)",
    convexSubtitle: "استعلامات تفاعلية - تحديث تلقائي!",
    realtimeInfo: "افتح هذا التطبيق في نافذة أخرى - تتم مزامنة المنشورات في الوقت الفعلي!",
    loadingPosts: "جارٍ تحميل المنشورات...",
    errorHeading: "تعذر تحميل المنشورات",
    retryButton: "إعادة المحاولة",
    formTitle: "إنشاء منشور",
    titlePlaceholder: "العنوان",
    contentPlaceholder: "المحتوى",
    createButton: "إنشاء منشور",
    emptyHeading: "لا توجد منشورات بعد",
    emptyContent: "أنشئ منشورك الأول أعلاه",
  },
  demoNavigator: {
    componentsTab: "عناصر",
    debugTab: "تصحيح",
