...
const ja: Translations = {
  ...
  dataDemoScreen: {
    supabaseTitle: "データデモ (Supabase)",
    supabaseSubtitle: "React Query + Supabase SDK",
    convexTitle: "データデモ (Convex)",
    convexSubtitle: "リアクティブクエリ - 自動更新！",
    realtimeInfo: "別のウィンドウでこのアプリを開くと、投稿がリアルタイムで同期されます！",
    loadingPosts: "投稿を読み込み中...",
    errorHeading: "投稿の読み込みに失敗しました",
    retryButton: "再試行",
    formTitle: "投稿を作成",
    titlePlaceholder: "タイトル",
    contentPlaceholder: "内容",
    createButton: "投稿を作成",
    emptyHeading: "まだ投稿がありません",
    emptyContent: "上から最初の投稿を作成してください",
  },
  demoNavigator: {
