...
const es: Translations = {
  ...
  dataDemoScreen: {
    supabaseTitle: "Demo de datos (Supabase)",
    supabaseSubtitle: "React Query + SDK de Supabase",
    convexTitle: "Demo de datos (Convex)",
    convexSubtitle: "Consultas reactivas, ¡se actualizan solas!",
    realtimeInfo: "Abre esta app en otra ventana: las publicaciones se sincronizan en tiempo real.",
    loadingPosts: "Cargando publicaciones...",
    errorHeading: "No se pudieron cargar las publicaciones",
    retryButton: "Reintentar",
    formTitle: "Crear publicación",
    titlePlaceholder: "Título",
    contentPlaceholder: "Contenido",
    createButton: "Crear publicación",
    emptyHeading: "Aún no hay publicaciones",
    emptyContent: "Crea tu primera publicación arriba",
  },
  demoNavigator: {
