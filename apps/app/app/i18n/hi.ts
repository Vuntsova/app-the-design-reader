...
const hi: Translations = {
  ...
  dataDemoScreen: {
    supabaseTitle: "डेटा डेमो (Supabase)",
    supabaseSubtitle: "React Query + Supabase SDK",
    convexTitle: "डेटा डेमो (Convex)",
    convexSubtitle: "रिएक्टिव क्वेरीज़ - अपने आप अपडेट!",
    realtimeInfo: "इस ऐप को दूसरी विंडो में खोलें - पोस्ट रीयल-टाइम में सिंक होते हैं!",
    loadingPosts: "पोस्ट लोड हो रहे हैं...",
    errorHeading: "पोस्ट लोड नहीं हो सके",
    retryButton: "पुनः प्रयास करें",
    formTitle: "पोस्ट बनाएँ",
    titlePlaceholder: "शीर्षक",
    contentPlaceholder: "सामग्री",
    createButton: "पोस्ट बनाएँ",
    emptyHeading: "अभी तक कोई पोस्ट नहीं",
    emptyContent: "ऊपर अपनी पहली पोस्ट बनाएँ",
  },
  demoNavigator: {
